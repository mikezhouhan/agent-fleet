...
- [下载十个源码仓库与获取 Cursor 恢复材料](SOURCE_DOWNLOAD.zh-CN.md)
- [六个项目的区别、优缺点与架构分析](analysis/multi-agent-grok-product-analysis.zh-CN.md)
- [九条底座演进路线](analysis/routes/README.md)
...
比较对象为 Kandev、Cindy、Grok Bot 0.18 重建版、Rakazo、Agent Orchestrator、DeepSeek Harness、Cursor Projects 客户端恢复材料、Omnigent、Agent Swarm、Memoh 与 Multica。原六项目报告保留其固定基准；2026-09-15 增补报告先后纳入五个新对象。报告基于固定源码快照，源码引用链接锁定到具体提交；完整版本记录见 [sources.json](sources.json)。
