...
const categories = Object.fromEntries(
  ["coordinator", "cloud_local_agents", "shared_context", "subscriptions"].map((id) => [
    id,
...
console.log(`commit=${result.provenance.payload.product.commit}`);
console.log(`primaryBundle=${result.provenance.payload.primaryBundle?.shippedPath}`);
